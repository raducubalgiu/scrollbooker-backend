...
class CommentPostLike(Base):
    ...
    __table_args__ = (
        ...
        Index("idx_commentpostlike_comment", "comment_id"),
        Index("idx_commentpostlike_author", "post_author_id"),
        Index("idx_commentpostlike_author_comment", "post_author_id", "comment_id")
    )