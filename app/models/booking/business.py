...
class Business(Base):
    ...
    business_owner = relationship("User", back_populates="owner_of_business", foreign_keys=[owner_id])
    employees = relationship("User", back_populates="employee_of_business", foreign_keys="User.business_employee_id")
