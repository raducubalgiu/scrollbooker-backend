from app.core.crud_helpers import db_create, db_get_all, db_delete, db_update
...
async def get_all_business_domain(db: DBSession, page: int, limit: int):
    return await db_get_all(db, model=BusinessDomain, page=page, limit=limit)
