...
from schema.user.user import UsernameUpdate, UserUpdateResponse
...
async def collect_user_username(
    ...
    try:
        ...
        updated_username: Optional[UserUpdateResponse] = await update_user_username(db, username_update, auth_user)
